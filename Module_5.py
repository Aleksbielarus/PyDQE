...
def console():
    type = str()
    cnt = 0
    welcome_message = 'please choose input type:\n' \
                       ' input "1" if manual\n' \
                       ' input "2" if using import from file\n' \
                       ' input "0" if you want to stop'
    manual_input = 'please, choose the note type:\n' \
                   ' input "1" if news\n' \
            ...
            if int(type) not in [1, 2, 0]:
                ...
                try:
                    ...
                    # NEWS NOTE
                        ...
                        type = int(input('Do you wish continue to add news?\n print "1" if yes\n print "0" if no.\n> '))
                    # PRIVATE AD
                    elif type == 2:
                        note_text = input("Please input message text:\n> ").capitalize()
